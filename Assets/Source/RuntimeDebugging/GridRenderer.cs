...
namespace RuntimeDebugging
{
	public class GridRenderer : MonoBehaviour
	{
		...
		private Material _materialClosest;
		...
		void Start()
		{
			...
			{
				color = new Color(0f, 0.96f, 1f)
			};
			_materialClosest = new Material(_materialMain)
			{
				color = new Color(0f, 1f, 0.64f)
			};
		}
		...
		void OnRenderObject()
		{
			...
			GlDrawCube(new Vector3(x + gridSize, y + gridSize, z), gridSize);
			GlDrawCube(new Vector3(x - gridSize, y + gridSize, z), gridSize);
			GlDrawCube(new Vector3(x + gridSize, y - gridSize, z), gridSize);
			GlDrawCube(new Vector3(x - gridSize, y - gridSize, z), gridSize);
			GlDrawCube(new Vector3(x + gridSize, y, z + gridSize), gridSize);
			GlDrawCube(new Vector3(x - gridSize, y, z + gridSize), gridSize);
			GlDrawCube(new Vector3(x + gridSize, y, z - gridSize), gridSize);
			GlDrawCube(new Vector3(x - gridSize, y, z - gridSize), gridSize);
			GlDrawCube(new Vector3(x, y + gridSize, z + gridSize), gridSize);
			GlDrawCube(new Vector3(x, y - gridSize, z + gridSize), gridSize);
			GlDrawCube(new Vector3(x, y + gridSize, z - gridSize), gridSize);
			GlDrawCube(new Vector3(x, y - gridSize, z - gridSize), gridSize);
			GL.End();
